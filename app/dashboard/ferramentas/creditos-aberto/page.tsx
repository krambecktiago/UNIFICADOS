  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="h-[68px] bg-white border-b border-gray-200 px-8 flex items-center">
        <div>
          <h1 className="text-base font-bold text-gray-900 leading-tight">Créditos em Aberto</h1>
          <p className="text-xs text-gray-400 leading-tight mt-0.5">Cruza créditos em aberto do fornecedor (TXT) com pagamentos do ERP (TXT) para identificar pendências.</p>
        </div>
      </div>
