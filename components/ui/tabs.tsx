      ...
      {tabs.map(tab => (
        <button
          ...
          className={cn(
            ...
            activeTab === tab.key ? `${tab.border} ${tab.text} bg-white dark:bg-gray-900` : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800'
          )}
        >
          {tab.label}
          <span
